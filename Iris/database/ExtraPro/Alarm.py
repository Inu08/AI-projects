...
extracted_time = open('D:\\Code\\Python\\main\\database\\NasaDataBase\\Solar Bodies\\Data.txt','rt')
time = extracted_time.read()
Time = str(time)

delete_time = open("D:\\Code\\Python\\main\\database\\NasaDataBase\\Solar Bodies\\Data.txt",'r+')
...
def RingerNow(time):
    ...
    while True:
        ...
        if current_time == Alarm_Time:
            ...
            playsound("D:\\Code\\Python\\main\\database\\Sounds\\1.mp3")
